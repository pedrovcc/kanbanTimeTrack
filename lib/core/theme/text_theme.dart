...
TextTheme createTextTheme(Brightness brightness) {
  ...
  return TextTheme(
    ...
    subtitle1: TextStyle(fontWeight: FontWeight.w500, fontSize: 16.8, color: color),
    ...
    button: TextStyle(fontWeight: FontWeight.w600, fontSize: 14, color: color),
  ).apply(fontFamily: 'Rawline');
}
